...
* Learn about future workshops and campus computing resources by joining the [Data Science Hub](http://datascience.wisc.edu/) email list.  To join send an email to [join-dshubcommunity@lists.wsic.edu](mailto:join-dshubcommunity@lists.wisc.edu) 
